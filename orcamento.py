...
class Em_aprovacao(Estado_de_um_orcamento):
    ...
    def finaliza(self, orcamento):
        raise Exception("Orcamento em aprovacao não podem ir para finalizado")
...
class Reprovado(Estado_de_um_orcamento):
    ...
    def aprova(self, orcamento):
        raise Exception("Orcamento reprovado")
...
class Finalizado(Estado_de_um_orcamento):
    def aplica_desconto_extra(self, orcamento):
        raise Exception('Orcamento finalizados não receberam desconto extra')

    def aprova(self, orcamento):
        raise Exception("Orcamento finalizado")
